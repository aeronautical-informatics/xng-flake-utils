    ...
    rec {
      ...
      lib.buildXngSysImage =
        ...
        assert pkgs.lib.lists.all
          ...
          (pkgs.lib.attrValues (builtins.trace extraBinaryBlobs extraBinaryBlobs));
        ...
        stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            args+=(${ builtins.concatStringsSep " " ( pkgs.lib.attrsets.mapAttrsToList (addr: src: "\"${src}@${addr}\"") extraBinaryBlobs ) })
